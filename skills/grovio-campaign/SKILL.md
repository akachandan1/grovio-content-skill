...
```
/grovio-campaign <brand_url> <campaign_type> <goal> <duration>
```

**Examples:**
```
/grovio-campaign https://grovio.ai product-launch free-trial 14-day
/grovio-campaign https://linear.app feature-launch new-roadmap-feature 7-day
/grovio-campaign https://notion.so lead-gen b2b-teams 30-day
/grovio-campaign https://grovio.ai event webinar-registration 3-week
/grovio-campaign https://figma.com awareness design-community 8-week
```
...
[ ] Landing page copy → /grovio-landing
[ ] Press release → /grovio-pr
[ ] Founder announcement post (LinkedIn) → /grovio-social --voice founder
[ ] Launch email → /grovio-email

Priority 2 (needed by Day 5):
[ ] TOF ad copy (Meta/LinkedIn/Google) → /grovio-ads
[ ] Nurture email sequence (3 emails) → /grovio-email
[ ] Retargeting ad variants → /grovio-ads

Priority 3 (ongoing throughout):
[ ] Community posts (Reddit/Discord) → /grovio-community
[ ] Daily/every-other-day social posts → /grovio-social
[ ] Video/Reel for social amplification → /grovio-video

Priority 4 (close phase):
[ ] Urgency email → /grovio-email
[ ] Final retargeting variants → /grovio-ads
[ ] Close social posts → /grovio-social
